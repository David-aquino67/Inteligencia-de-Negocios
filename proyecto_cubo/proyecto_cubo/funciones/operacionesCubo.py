"""
Módulo de Operaciones OLAP

Este archivo contiene todas las funciones para realizar
operaciones analíticas sobre un DataFrame de ventas,
simulando un cubo OLAP.
